...
def generate_sps_parameters(nsamples, prior_parameters, redshift_mass_prior_data, uniform_redshift_mass=False, uniform_logf=False):
    ...
    :param uniform_redshift_mass:
        If true replaces observationally motivated redshift and mass
        priors with uniform priors. Used primarily for training emulators
    
    :param uniform_logf:
        If true replaces priors on log sfr ratios to be uniform. Used
        for training
