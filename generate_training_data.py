...
photometry = sps.simulate_photometry(sps_parameters, "lsst", imf=1, dust=0, nebem=True, zhistory=False, enable_mpi=True, lya_uncertainity=False, mpi_rank=rank, save_spec=True, run_count=run_count)
