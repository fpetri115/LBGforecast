...
class NzModel:
    ...
    def save_4pca_data(self):
        ...
        np.save("4pca_components_u.npy", u_pca_data[1])
        np.save("4pca_components_g.npy", g_pca_data[1])
        np.save("4pca_components_r.npy", r_pca_data[1])
        
        np.save("4pca_mean_u.npy", u_pca_data[2])
        np.save("4pca_mean_g.npy", g_pca_data[2])
        np.save("4pca_mean_r.npy", r_pca_data[2])
        
        np.save("4pca_means_u.npy", u_pca_means)
        np.save("4pca_means_g.npy", g_pca_means)
        np.save("4pca_means_r.npy", r_pca_means)
        
        np.save("4pca_cov_u.npy", u_pca_cov)
        np.save("4pca_cov_g.npy", g_pca_cov)
        np.save("4pca_cov_r.npy", r_pca_cov)